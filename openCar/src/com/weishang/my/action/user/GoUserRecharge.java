...
@WebServlet(displayName="跳转到用户充值",name="GoUserRecharge",urlPatterns="/pc/goUserRecharge")
public class GoUserRecharge extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public GoUserRecharge() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if(ordinary_user==null){//非登陆用户
			...
			RequestDispatcher rd = request.getRequestDispatcher("/template/default/page/user/user_recharge.jsp");
			rd.forward(request,response);
		}
	}
